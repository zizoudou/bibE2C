...
<body>
   ...
   ?>
    ...
    <article>
        ...
        <p>Au-delà de l’apprentissage technique, l’E2C valorise la lecture comme un levier de développement personnel. Lire permet aux jeunes de se reconnecter à leur curiosité, de découvrir des univers variés et de mieux comprendre leur environnement. C’est aussi un moyen de reprendre goût à l’apprentissage, dans un cadre bienveillant où chaque progrès est valorisé. La lecture devient ainsi un fil conducteur vers la reconstruction de soi et l’élaboration d’un avenir choisi.</p></div>

        <iframe id="video-e2c" src="https://www.youtube.com/embed/q8IXhr6b304?si=u7vxY-6vBz4Vs8gz" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
        </div>
...
<div class="it2">
    ...
    <img id="groupe" src="./src/bannerOld.jpg" alt="Le groupe prépa Numérique">
    </article>
    ...
    <aside>
        <div id="close">X</div> 
    <article>
        🎉 Le Fest Num revient à Roubaix le 24 juin !

        La Prépa Numérique de l’E2C Grand Lille vous donne rendez-vous le 24 juin 2025 sur le site de Roubaix pour une nouvelle édition du Fest Num, un événement festif et créatif dédié au numérique. Porté par les jeunes en formation, ce festival mettra en lumière leurs projets web, leurs créations graphiques, leurs prototypes interactifs… et bien plus encore ! Une belle occasion de découvrir les talents de demain, d’échanger autour des métiers du digital et de célébrer l’innovation dans une ambiance conviviale et inspirante.

        <img id="festnum" src="./src/festNum.jpg" alt="Fest Num">
